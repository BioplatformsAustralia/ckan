window.popover_context = {
  dict: { user: {}, dataset: {}, group: {} },
  render: { user: {}, dataset: {}, group: {} }
};
this.ckan.module("popover-context", function($) {
  return {
    ...
    initialize: function() {
      if (this.options.id != true && this.options.id != null) {
        ...
        this.el.popover({
          ...
          html: true,
          content:
            this.options.throbber.replace("{SITE_ROOT}", ckan.SITE_ROOT) +
            this._("Loading..."),
          placement: "bottom"
        });
        ...
        this.sandbox.subscribe(
          "follow-follow-" + this.options.id,
          this._onHandleFollow
        );
        this.sandbox.subscribe(
          "follow-unfollow-" + this.options.id,
          this._onHandleFollow
        );
      }
    },
    ...
    _onHandleError: function(error) {
      $(
        '[data-module="popover-context"][data-module-type="' +
          this.options.type +
          '"][data-module-id="' +
          this.options.id +
          '"]'
    ...
    _onRenderPopover: function(html) {
      ...
      if (typeof popover.$tip != "undefined") {
        ...
        $(".popover-title", tip).html(
          '<a href="javascript:;" class="popover-close">&times;</a>' + title
        );
