  ...
  return {
    ...
    initialize: function() {
      ...
      if (rows) {
        ...
        var seperator = $(template_seperator).insertAfter(
          $(".toggle-more:last-child", this.el)
        );
    ...
    _onShowMore: function($e) {
      $e.preventDefault();
      this.el.removeClass("table-toggle-more").addClass("table-toggle-less");
    },
    _onShowLess: function($e) {
      $e.preventDefault();
      this.el.removeClass("table-toggle-less").addClass("table-toggle-more");
    }
  };
});
