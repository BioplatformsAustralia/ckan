this.ckan.module("resource-view-filters", function(jQuery) {
  ...
  function initialize() {
    var self = this,
      ...
      addFilterTemplate =
        '<a class="btn btn-primary" href="#">' + self._("Add Filter") + "</a>",
      filtersDiv = $("<div></div>");
    var filters = ckan.views.filters.get();
    _appendDropdowns(filtersDiv, resourceId, dropdownTemplate, fields, filters);
    var addFilterButton = _buildAddFilterButton(
      self,
      filtersDiv,
      addFilterTemplate,
      fields,
  ...
  function _buildAddFilterButton(
    self,
    el,
    template,
    fields,
    ...
    addFilterButton.click(function(evt) {
      var addFilterDiv = $(
          '<div class="resource-view-filter"><input type="hidden"></input></div>'
        ),
