this.ckan.module("image-upload", function($) {
  return {
    ...
    initialize: function() {
      ...
      this.is_data_resource =
        this.options.field_url === "url" &&
        this.options.field_upload === "upload";
      var checkbox = $(field_clear, this.el);
      if (checkbox.length > 0) {
        checkbox.parents(".form-group").remove();
      }
      this.field_clear = $(
        '<input type="hidden" name="' + options.field_clear + '">'
      ).appendTo(this.el);
      this.button_url = $(
        ...
        .prop(
          "title",
          this._("Link to a URL on the internet (you can also link to an API)")
        )
