describe("ckan.module(id, properties|callback)", function() {
  ...
  describe(".initialize()", function() {
    beforeEach(function() {
      this.element1 = jQuery('<div data-module="test1">').appendTo(
        this.fixture
      );
      this.element2 = jQuery('<div data-module="test1">').appendTo(
        this.fixture
      );
      this.element3 = jQuery('<div data-module="test2">').appendTo(
        this.fixture
      );
      this.test1 = sinon.spy();
      ckan.module.registry = { test1: this.test1 };
    ...
    it("should initialize more than one module sepearted by a space", function() {
      this.fixture.empty();
      this.element4 = jQuery('<div data-module="test1 test2">').appendTo(
        this.fixture
      );
    ...
    it("should defer all published events untill all modules have loaded", function() {
      ...
      var callbacks = [];
      ckan.module.registry = { test1: function() {}, test2: function() {} };
      this.target.restore();
  ...
  describe(".createInstance(Module, element)", function() {
    beforeEach(function() {
      ...
      this.factory.options = this.defaults = {
        test1: "a",
        test2: "b",
        test3: "c"
      };
      this.sandbox = { i18n: { translate: sinon.spy() } };
    ...
    it("should push further instances into the existing array under ckan.module.instances", function() {
      var target = function MyModule() {
        return { mock: "instance3" };
      };
      target.namespace = "test";
      ckan.module.instances.test = [
        { mock: "instance1" },
        { mock: "instance2" }
      ];
      ckan.module.createInstance(target, this.element);
  ...
  describe(".extractOptions(element)", function() {
    ...
    it("should set boolean attributes to true", function() {
      var element = jQuery("<div>", { "data-module-long-property": "" })[0];
      var target = ckan.module.extractOptions(element);
